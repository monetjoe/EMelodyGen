...
[![Python application](https://github.com/monetjoe/EMelodyGen/actions/workflows/python-app.yml/badge.svg?branch=data)](https://github.com/monetjoe/EMelodyGen/actions/workflows/python-app.yml?query=branch%3Adata)
